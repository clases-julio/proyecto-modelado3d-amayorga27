...
def right_shoulder(name, flip):
    ...
    bpy.context.object.scale[0] = 0.35
    bpy.context.object.scale[1] = 0.35
...
right_shoulder("R_shoulder", False)
context.object.location[0] = -1.8
right_shoulder("L_shoulder", True)
