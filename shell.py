...
def shoulder(name, flip):
    ...
    bpy.context.object.location[1] = 1.25713
...
def base():
    ...
    bpy.ops.mesh.primitive_cylinder_add(radius=1, depth=2, enter_editmode=False, location=(0, 0, 0))
    right_base = context.active_object
    bpy.context.object.scale[0] = 2.24
    bpy.context.object.scale[1] = 0.84
    bpy.context.object.scale[2] = 0.012
    bpy.context.object.location[0] = -2.34
    bpy.context.object.location[1] = 1.71
    bpy.context.object.location[2] = -0.11
    bpy.context.object.rotation_euler[2] = 1.12574




    bpy.ops.mesh.primitive_cylinder_add(radius=1, depth=2, enter_editmode=False, location=(0, 0, 0))
    left_base = context.active_object
    bpy.context.object.scale[0] = 2.24
    bpy.context.object.scale[1] = 0.84
    bpy.context.object.scale[2] = 0.012
    ...
    center_base = context.active_object
    bpy.context.object.scale[0] = 0.5
    bpy.context.object.scale[1] = 0.84
    bpy.context.object.scale[2] = 0.012
    bpy.context.object.location[0] = -1.58
    bpy.context.object.location[1] = 1.26
    bpy.context.object.location[2] = -0.11

    right_shoulder.select_set(True)
    left_shoulder.select_set(True)
    front_base.select_set(True)
    right_base.select_set(True)
    left_base.select_set(True)
...
def shell():
    ...
    bpy.context.object.scale[0] = 2.05
    bpy.context.object.scale[1] = 1.12
    bpy.context.object.scale[2] = 1.33
    bpy.context.object.location[0] = 0.08
    bpy.context.object.location[1] = -1.09
    ...
    bpy.context.object.scale[2] = 1.32
    bpy.context.object.location[0] = 0.08
    ...
    bpy.context.object.location[0] = 0
    bpy.context.object.location[1] = -3.1811
    ...
    bpy.context.object.scale[0] = 2.04
    ...
    bpy.context.object.scale[1] = 2.61
